...
namespace Backend.Migrations
{
    ...
    [Migration("20260816040033_AddTasks")]
            ...
            modelBuilder.Entity("Backend.Models.TaskItem", b =>
                {
                    ...
                    b.HasIndex("UpdatedBy")
                        .HasDatabaseName("ix_tasks_updated_by");

                    b.HasIndex("ProjectId", "Status", "Position")
                        .HasDatabaseName("ix_tasks_project_id_status_position");
            ...
            modelBuilder.Entity("Backend.Models.TaskItem", b =>
                {
                    ...
                    b.HasOne("Backend.Models.User", "Updater")
                        ...
                        .HasForeignKey("UpdatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_tasks_users_updated_by");
